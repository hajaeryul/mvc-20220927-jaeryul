...
import com.study.mvc20220927jaeryul.dto.UserReqDto;
...
//        System.out.println("map: " + map.toString());
    ...
    public Object addUserJSON(@RequestBody UserReqDto userReqDto) { /* dto에 getter setter가 있어야만 잭슨이 object를 json 으로 변환해줌 !!*/
